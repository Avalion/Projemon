...
public class ActionAleaMessage : MapObjectAction {
    ...
    public override void Execute() {
        World.Current.ExecuteActions(new List<MapObjectAction>() { new ActionMessage(face, m_messagesList[Random.Range(0, m_messagesList.Length - 1)], faceOnRight) }, delegate() { Terminate(); });
    }
